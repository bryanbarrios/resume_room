...
class KColors {
  ...
  static const Color lightThemePrimaryColor = Color(0xfffb8500);
  static const Color lightThemePrimaryDarkColor = Color(0xff023047);
  static const Color lightThemePrimaryLightColor = Color(0xff365973);
  static const Color lightThemeAccentColor = Color(0xffffBF69);
  static const Color lightThemeBackgroundColor = Color(0xffffffff);

  static const Color darkThemePrimaryColor = Color(0xfffb8500);
  static const Color darkThemePrimaryDarkColor = Color(0xff000000);
  static const Color darkThemePrimaryLightColor = Color(0xff2b2c3d);
  static const Color darkThemeAccentColor = Color(0xffFB8500);
  static const Color darkThemeBackgroundColor = Color(0xff000017);
